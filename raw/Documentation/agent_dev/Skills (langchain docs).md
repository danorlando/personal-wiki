...
tags:
  ...
  - "agent_dev"
---
Skills are reusable agent capabilities that provide specialized workflows and domain knowledge. You can use [Agent Skills](https://agentskills.io/) to provide your deep agent with new capabilities and expertise. For ready-to-use skills that improve your agent’s performance on LangChain ecosystem tasks, see the [LangChain Skills](https://github.com/langchain-ai/langchain-skills) repository. Deep agent skills follow the [Agent Skills specification](https://agentskills.io/specification).
...
The SDK only loads the sources you pass in `skills`. It does not automatically scan CLI directories such as `~/.deepagents/...` or `~/.agents/...`.For CLI storage conventions, see [App data](https://docs.langchain.com/oss/python/deepagents/data-locations).
...
Skills and [memory](https://docs.langchain.com/oss/python/deepagents/customization#memory) (`AGENTS.md` files) serve different purposes:
