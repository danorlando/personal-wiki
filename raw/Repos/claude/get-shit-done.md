...
[Why I Built This](#why-i-built-this) · [How It Works](#how-it-works) · [Commands](#commands) · [Why It Works](#why-it-works) · [User Guide](https://github.com/gsd-build/get-shit-done/blob/main/docs/USER-GUIDE.md)
...
> 3. Review [docs/USER-GUIDE.md](https://github.com/gsd-build/get-shit-done/blob/main/docs/USER-GUIDE.md) and the [CHANGELOG](https://github.com/gsd-build/get-shit-done/blob/main/CHANGELOG.md) for updates — a lot has changed since you were last here
> 
...
> [!tip] Tip
> For source-based installs or environments where npm is unavailable, see **[docs/manual-update.md](https://github.com/gsd-build/get-shit-done/blob/main/docs/manual-update.md)**.
...
Use `--global` (`-g`) or `--local` (`-l`) to skip the location prompt. Use `--claude`, `--opencode`, `--gemini`, `--kilo`, `--codex`, `--copilot`, `--cursor`, `--windsurf`, `--antigravity`, `--augment`, `--trae`, `--cline`, or `--all` to skip the runtime prompt. Use `--sdk` to also install the GSD SDK CLI (`gsd-sdk`) for headless autonomous execution.
...
> **Assumptions Mode:** Prefer codebase analysis over questions? Set `workflow.discuss_mode` to `assumptions` in `/gsd-settings`. The system reads your code, surfaces what it would do and why, and only asks you to correct what's wrong. See [Discuss Mode](https://github.com/gsd-build/get-shit-done/blob/main/docs/workflow-discuss-mode.md).
...
GSD stores project settings in `.planning/config.json`. Configure during `/gsd-new-project` or update later with `/gsd-settings`. For the full config schema, workflow toggles, git branching options, and per-agent model breakdown, see the [User Guide](https://github.com/gsd-build/get-shit-done/blob/main/docs/USER-GUIDE.md#configuration-reference).
...
[![Star History Chart](https://camo.githubusercontent.com/7dd96c0bf87a45304ff893d3280cb88546481e51119beb239349b3b0f319b7c9/68747470733a2f2f6170692e737461722d686973746f72792e636f6d2f7376673f7265706f733d6773642d6275696c642f6765742d736869742d646f6e6526747970653d44617465)](https://star-history.com/#gsd-build/get-shit-done&Date)
