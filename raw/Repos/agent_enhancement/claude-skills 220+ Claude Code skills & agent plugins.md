---
title: "alirezarezvani/claude-skills: 220+ Claude Code skills & agent plugins for Claude Code, Codex, Gemini CLI, Cursor, and 8 more coding agents — engineering, marketing, product, compliance, C-level advisory."
source: "https://github.com/alirezarezvani/claude-skills"
author:
published:
created: 2026-04-06
description: "220+ Claude Code skills & agent plugins for Claude Code, Codex, Gemini CLI, Cursor, and 8 more coding agents — engineering, marketing, product, compliance, C-level advisory. - alirezarezvani/claude-skills"
tags:
  - "agent_enhancement"
  - "agent_skills"
  - "repository"
...
| --- | --- | --- | --- |
| **🔧 Engineering — Core** | 37 | Architecture, frontend, backend, fullstack, QA, DevOps, SecOps, AI/ML, data, Playwright, self-improving agent, security suite (6), a11y audit | [engineering-team/](https://github.com/alirezarezvani/claude-skills/blob/main/engineering-team) |
| **🎭 Playwright Pro** | 9+3 | Test generation, flaky fix, Cypress/Selenium migration, TestRail, BrowserStack, 55 templates | [engineering-team/playwright-pro](https://github.com/alirezarezvani/claude-skills/blob/main/engineering-team/playwright-pro) |
| **🧠 Self-Improving Agent** | 5+2 | Auto-memory curation, pattern promotion, skill extraction, memory health | [engineering-team/self-improving-agent](https://github.com/alirezarezvani/claude-skills/blob/main/engineering-team/self-improving-agent) |
| **⚡ Engineering — POWERFUL** | 42 | Agent designer, RAG architect, database designer, CI/CD builder, security auditor, MCP builder, AgentHub, Helm charts, Terraform, self-eval | [engineering/](https://github.com/alirezarezvani/claude-skills/blob/main/engineering) |
| **🎯 Product** | 15 | Product manager, agile PO, strategist, UX researcher, UI design, landing pages, SaaS scaffolder, analytics, experiment designer, discovery, roadmap communicator, code-to-prd | [product-team/](https://github.com/alirezarezvani/claude-skills/blob/main/product-team) |
| **📣 Marketing** | 45 | 7 pods: Content (8), SEO (5), CRO (6), Channels (6), Growth (4), Intelligence (4), Sales (2) + context foundation + orchestration router. 32 Python tools. | [marketing-skill/](https://github.com/alirezarezvani/claude-skills/blob/main/marketing-skill) |
| **📋 Project Management** | 9 | Senior PM, scrum master, Jira, Confluence, Atlassian admin, templates | [project-management/](https://github.com/alirezarezvani/claude-skills/blob/main/project-management) |
| **🏥 Regulatory & QM** | 14 | ISO 13485, MDR 2017/745, FDA, ISO 27001, GDPR, CAPA, risk management | [ra-qm-team/](https://github.com/alirezarezvani/claude-skills/blob/main/ra-qm-team) |
| **💼 C-Level Advisory** | 34 | Full C-suite (10 roles) + orchestration + board meetings + culture & collaboration | [c-level-advisor/](https://github.com/alirezarezvani/claude-skills/blob/main/c-level-advisor) |
| **📈 Business & Growth** | 5 | Customer success, sales engineer, revenue ops, contracts & proposals | [business-growth/](https://github.com/alirezarezvani/claude-skills/blob/main/business-growth) |
| **💰 Finance** | 4 | Financial analyst (DCF, budgeting, forecasting), SaaS metrics coach (ARR, MRR, churn, LTV, CAC) | [finance/](https://github.com/alirezarezvani/claude-skills/blob/main/finance) |
...
| --- | --- | --- |
| [**Startup CTO**](https://github.com/alirezarezvani/claude-skills/blob/main/agents/personas/startup-cto.md) | Engineering + Strategy | Architecture decisions, tech stack selection, team building, technical due diligence |
| [**Growth Marketer**](https://github.com/alirezarezvani/claude-skills/blob/main/agents/personas/growth-marketer.md) | Marketing + Growth | Content-led growth, launch strategy, channel optimization, bootstrapped marketing |
| [**Solo Founder**](https://github.com/alirezarezvani/claude-skills/blob/main/agents/personas/solo-founder.md) | Cross-domain | One-person startups, side projects, MVP building, wearing all hats |
...
See [agents/personas/](https://github.com/alirezarezvani/claude-skills/blob/main/agents/personas) for details. Create your own with [TEMPLATE.md](https://github.com/alirezarezvani/claude-skills/blob/main/agents/personas/TEMPLATE.md).
...
See [orchestration/ORCHESTRATION.md](https://github.com/alirezarezvani/claude-skills/blob/main/orchestration/ORCHESTRATION.md) for the full protocol and examples.
...
**Are the Python tools dependency-free?** Yes. All 332 Python CLI tools use the standard library only — zero pip installs required. Every script is verified to run with `--help`.

**How do I create my own Claude Code skill?** Each skill is a folder with a `SKILL.md` (frontmatter + instructions), optional `scripts/`, `references/`, and `assets/`. See the [Skills & Agents Factory](https://github.com/alirezarezvani/claude-code-skills-agents-factory) for a step-by-step guide.

---

## Contributing

We welcome contributions! See [CONTRIBUTING.md](https://github.com/alirezarezvani/claude-skills/blob/main/CONTRIBUTING.md) for guidelines.
...
MIT — see [LICENSE](https://github.com/alirezarezvani/claude-skills/blob/main/LICENSE) for details.

---

## Star History

[![Star History Chart](https://camo.githubusercontent.com/d19b6b0d9ddf2763ede2ddc57e30a91435546b18e918a16183855d5eb145d0e5/68747470733a2f2f6170692e737461722d686973746f72792e636f6d2f7376673f7265706f733d616c6972657a6172657a76616e692f636c617564652d736b696c6c7326747970653d44617465)](https://star-history.com/#alirezarezvani/claude-skills&Date)
