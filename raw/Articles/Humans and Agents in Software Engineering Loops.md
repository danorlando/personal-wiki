...
![The software delivery feedback loops: An upper "why" loop connected to a lower “how” loop. The why loop iterates over an idea and working software. The how loop iterates over interim artefacts like specs, code, and tests.](https://martinfowler.com/articles/exploring-gen-ai/humans-agents-image1.png)
...
![Multiple levels of “how” loops supporting the “why” loop. An outer loop iterates on a feature. A middle loop iterates on stories. An inner loop iterates on code.](https://martinfowler.com/articles/exploring-gen-ai/humans-agents-image2.png)
...
![Humans outside the loop: An upper "why" loop with a human on top. The loop iterates over an idea and working software. This is connected to a lower "how" loop by a robot, which iterates over interim artefacts like code.](https://martinfowler.com/articles/exploring-gen-ai/humans-agents-image3.png)
...
![Humans in the loop: A single “why+how” loop with a human at the top and a robot at the bottom. The loop iterates over idea, interim artefacts like code and tests, and the working software.](https://martinfowler.com/articles/exploring-gen-ai/humans-agents-image4.png)
...
![Flywheel: An upper "why" loop connected to a lower “how” loop by a human and a robot. The why loop iterates over an idea and working software. The how loop iterates over interim artefacts like specs.](https://martinfowler.com/articles/exploring-gen-ai/humans-agents-image6.png)
